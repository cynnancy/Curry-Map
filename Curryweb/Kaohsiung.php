...
<html lang="en">
    <head>
        ...
        <title>Curry Map-Kaohsiung</title>
                        ...
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                                <h2 class="section-heading mb-4">
                                    <span class="section-heading-upper">Strong Taste, Strong Spices</span>
                                    <span class="section-heading-lower">About Curry Map</span>
                                </h2>
                                <p>Founded in 2022 by Nancy Chang and Christing Wei.</p>
                                <p class="mb-0"></p>
                                <p>We're dedicated to finding the best curry, may more and more people find their
                                    <em>destined curry.</em>
                                    Join us for your delicious food routine.
                                </p>
                            </div>
                        </div>
                    </div>
